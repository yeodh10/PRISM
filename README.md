...
> 개인정보·데이터 규제 법령(개인정보보호법·정보통신망법·신용정보법·위치정보법·AI기본법)을 자연어로 질문하면, 관련 조문을 **검색**해 쉬운 말로 답하고 **출처(법령·조/항/호)를 인용**하는 RAG 챗봇.
...
- **법령·조문 범위**: **5개 법령 + 개인정보보호법 시행령, 총 104개 조문** — 개인정보보호법(수집·이용·동의·정보주체 권리·가명정보·적용범위·CPO·감독제재·손해배상·과징금 등 53), 정보통신망법(불법정보·침해금지·스팸·침해사고 신고·정보보호조치 등 12), 신용정보법(개인신용정보·자동화평가·마이데이터·손해배상 등 13), 위치정보법(수집·이용·정보주체 권리·긴급구조·8세 이하 아동 보호 등 12), AI기본법(고영향 AI·생성형 AI 투명성·영향평가·윤리원칙 등 7), 개인정보보호법 시행령(안전조치·영향평가·유출 통지/신고 등 7). law.go.kr로 추가 법령·조문 확장 가능. **법령 필터·크로스-법령 상호참조·법↔시행령 연결 ✅ 구현**(예: 신용정보법 제40조 → 정보통신망법 제50조 준용, 법 제29조 안전조치 → 시행령 제30조 세부기준). *구어체 쿼리 리랭킹·타 법 시행령은 향후 과제.*
...
├── data/                  # 법령별 조문 JSON(pipa·network_act·credit_info·ai_act·location_info·pipa_decree) 104개
