...
- **법령·조문 범위**: **5개 법령 61개 조문** — 개인정보보호법(수집·이용·동의·정보주체 권리·CPO·과징금 등 37조문), 정보통신망법(불법정보·침해금지·스팸 등), 신용정보법(개인신용정보·자동화평가 등), 위치정보법(개인위치정보 수집·이용·정보주체 권리·8세 이하 아동 보호 등), AI기본법(고영향 AI·생성형 AI 투명성 등). law.go.kr로 추가 법령·조문 확장 가능. **법령 필터(전체/법령별) ✅ 구현.** *크로스-법령 상호참조 연결은 향후 과제.*
